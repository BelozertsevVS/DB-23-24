...
CREATE TABLE SALESSE (
SALES_ORDER_ID INT, -- Унікальний ідентифікатор замовлення - число без дробової частини - може бути більше ніж 2147483647
REVISION_NUMBER TINYINT, -- Інкремент для відстеження зміни за замовленням - число без дробової частини - не більше 255
ORDER_DATE DATETIME, -- Дата і час створення замовлення - дата і час
DUE_DATE DATE, -- Дата доставки замовлення - дата
SHIP_DATE DATE, -- Фактична дата доставки замовлення - дата
ONLINE_ORDER_FLAG TINYINT, -- 0 = Замовлення було створено менеджером. 1 = Замовлення було створено онлайн - число без дробової частини - не більше 1
CUSTOMER_ID BIGINT,-- Унікальний ідентифікатор клієнта, який здійснив замовлення - число без дробової частини - не більше 2147483647
SALES_PERSON_ID BIGINT, -- Унікальний ідентифікатор співробітника, який провів замовлення - число без дробової частини - не більше 2147483647
TERRITORY_ID BIGINT, -- Унікальний ідентифікатор території - число без дробової частини - не більше 2147483647
SUB_TOTAL FLOAT, -- Загальна сума замовлення - грошова величина - може бути більше ніж 214748.3647
TAX_AMT FLOAT, -- Загальна сума податків - грошова величина - не більше 214748.3647
FREIGHT FLOAT, -- Сума доставки - грошова величина - не більше 214748.3647
MODIFIED_DATE DATETIME, -- Дата і час останньої зміни рядка
);

USE SHOP;
GO
INSERT INTO SALESSE (SALES_ORDER_ID, REVISION_NUMBER, ORDER_DATE, DUE_DATE, SHIP_DATE, ONLINE_ORDER_FLAG,
